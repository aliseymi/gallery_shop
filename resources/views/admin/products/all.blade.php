                    ...
                    <div class="col-12">
                        <h1 class="m-0 text-dark">
                            ...
                            <a class="btn btn-primary float-left text-white py-2 px-4"
                                href="{{ route('admin.products.create') }}">افزودن محصول جدید</a>
                        </h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($products as $product)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.product.edit', $product->id) }}" class="btn btn-default btn-icons"><i
                                                            class="fa fa-edit"></i></a>

                                                    <form action="{{ route('admin.products.delete', $product->id) }}" class="d-inline" method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button class="btn btn-default btn-icons deleteBtn" data-title="{{ $product->title }}" type="button"><i class="fa fa-trash"></i></button>
                                                    </form>
    ...
    $('.deleteBtn').on('click', function(e) {
      ...
      let title = btn.data('title') 
        ...
        Swal.fire({
            ...
            iconColor: '#ed2121',
            title: 'توجه',
            html: `آیا از حذف محصول <strong>${title}</strong> اطمینان دارید؟`,
            showCancelButton: true,
            confirmButtonText: 'بله',
            confirmButtonColor: '#0bbd52',
            reverseButtons: true,
            cancelButtonText: 'منصرف شدم',
            cancelButtonColor: '#e02b2b',
            focusCancel: true
