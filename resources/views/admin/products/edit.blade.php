                          ...
                          <div class="card-body">
                              ...
                              <div class="row">
                                  <div class="col-md-4">
                                      ...
                                      <img src="/{{ $product->thumbnail_url }}" alt="تصویر شاخص" width="100" height="100">
                                  </div>
                                  <div class="col-md-4">
                                      <div class="form-group">
                                      ...
                                      <img src="/{{ $product->demo_url }}" alt="تصویر محصول" width="100" height="100">
                                  </div>
                                  <div class="col-md-4">
                                      <div class="form-group">
                                      ...
                                      <a href="{{ route('admin.products.download.source', $product->id) }}"
                                        class="btn btn-default btn-icons" title="لینک دانلود">دانلود فایل اصلی</a>
                                  </div>
