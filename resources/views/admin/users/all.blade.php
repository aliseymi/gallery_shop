                          ...
                          <table class="table table-hover mb-0">
                              ...
                              <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('admin.users.delete', $user->id) }}" class="d-inline" method="post">
                                        @csrf
                                        @method('delete')

                                        <button type="button" class="btn btn-default btn-icons deleteBtn" data-name="{{ $user->name }}"><i class="fa fa-trash"></i></button>
                                    </form>
                                </td>
                            </tr>
                              @endforeach
    ...
    $('.deleteBtn').on('click', function(e) {
      ...
      let name = btn.data('name') 
        ...
        Swal.fire({
            ...
            iconColor: '#ed2121',
            title: 'توجه',
            html: `آیا از حذف کاربر <strong>${name}</strong> اطمینان دارید؟`,
