            ...
            <div class="wrap-menu-desktop how-shadow1">
                <nav class="limiter-menu-desktop container">
                    ...
                    <div class="wrap-icon-header flex-w flex-r-m">
                        ...
                        @endphp
                            data-notify="{{ collect($cart)->count() }}">
                    ...
                    @if ($cart)
                        @foreach (json_decode(Cookie::get('cart'), true) as $id => $value)
                            <li class="header-cart-item flex-w flex-t m-b-12">
                                <a href="{{ route('home.cart.remove', $id) }}">
                                ...
                                <div class="header-cart-item-txt p-t-8">
                                    <a href="{{ route('home.products.show', $id) }}"
                        ...
                        @endforeach
                    @else
                        <p class="alert alert-primary">سبد خرید شما خالی میباشد</p>
                    @endif
                </ul>
